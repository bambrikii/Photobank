...
/**
 * Wraps a class so that Javascript code can more easily perform reflection on
 * the class, such as calling its static methods. Note that the marshalling code
 * is not perfect.
 *
 * @author dfhuynh
 */
public class ClassWrapper {
	...
	/**
	 * @return a set of unique Strings that are names of methods of the wrapped
	 *         class
	 */
	...
	/**
	 * @return a set of unique Strings that are names of fields of the wrapped
	 *         class
	 */
	...
	/**
	 * Calls the static method of the given name with the given array of
	 * arguments. Performs coercion as much as possible.
	 *
	 * @param name
	 * @param arguments
	 * @return
	...
	/**
	 * Constructs an instance of the wrapped class with the given array of
	 * arguments.
	 *
	 * @param arguments
	 * @return
