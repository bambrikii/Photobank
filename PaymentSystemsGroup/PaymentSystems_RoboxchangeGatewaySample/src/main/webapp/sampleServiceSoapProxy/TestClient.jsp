...
<FRAMESET  COLS="220,*">
<FRAME SRC="<%=request.getContextPath() %>/sampleServiceSoapProxy/Method.jsp" NAME="methods" MARGINWIDTH="1" MARGINHEIGHT="1" SCROLLING="yes" FRAMEBORDER="1">
<FRAMESET  ROWS="80%,20%">
<FRAME SRC="<%=request.getContextPath() %>/sampleServiceSoapProxy/Input.jsp" NAME="inputs"  MARGINWIDTH="1" MARGINHEIGHT="1" SCROLLING="yes" FRAMEBORDER="1">
<%
StringBuffer resultJSP = new StringBuffer(request.getContextPath());
resultJSP.append("/sampleServiceSoapProxy/Result.jsp");
resultJSP.append("?");
