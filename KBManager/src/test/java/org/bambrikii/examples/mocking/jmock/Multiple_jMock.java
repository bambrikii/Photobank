...
// http://jeantessier.com/SoftwareEngineering/Mocking.html#UsingOneorMoreMocksTogether
public class Multiple_jMock extends TestCase {
	...
	public void testSome() {
		...
		SomeOtherInterface mockSomeOther = context
				.mock(SomeOtherInterface.class);
